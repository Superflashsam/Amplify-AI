         ...
         <div className="max-w-[1400px] mx-auto px-6 relative z-10">
            ...
            <div className="text-center max-w-3xl mx-auto pb-12">
               ...
               <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="group relative inline-flex items-center gap-3 px-10 py-5 btn-gradient rounded-full text-white text-xl font-bold shadow-2xl shadow-primary/30 hover:shadow-primary/50 transition-all overflow-hidden"
               >
                  <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
                  <span className="relative whitespace-nowrap z-10 text-shadow-sm">Start Free Trial</span>
