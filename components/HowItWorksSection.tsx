    ...
    <div className="relative w-full h-full p-6 flex items-center justify-center bg-slate-50/50">
      ...
      >
        ...
        <motion.button
           ...
           className={`w-full py-2.5 rounded-lg text-xs font-bold flex items-center justify-center gap-2 transition-all duration-300 ${
              stage === 'success' ? 'bg-green-500 text-white shadow-green-200' : 'bg-gray-900 text-white shadow-[0_0_0_2px_rgba(151,125,255,0.3)] hover:shadow-[0_0_0_2px_rgba(151,125,255,0.6)]'
           } shadow-lg`}
        >
           {stage === 'generating' ? (
              <>
      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <motion.h2 
             ...
             viewport={{ once: true }}
             transition={{ delay: 0.1 }}
             className="font-display font-bold text-3xl md:text-4xl lg:text-5xl text-dark mb-6 tracking-tight"
          >
