...
export const metadata: Metadata = {
  title: 'AmplifyAI - AI-Powered Marketing That Scales Your Brand',
  description: 'Generate on-brand content, orchestrate campaigns, and track performance—all in one intelligent platform.',
};
